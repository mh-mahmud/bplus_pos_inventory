...
$stock_data = $this->db->query("SELECT product_id, product_code, sale_id, net_unit_price, quantity, unit_quantity FROM sma_sale_items WHERE quantity != unit_quantity")->result();
    ...
    <header id="header" class="navbar">
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    <?php if(count($stock_data)) : ?>
                        <li class="dropdown hidden-xs">
                            <a class="btn tip" title="Stock Adjustment" data-placement="bottom" href="<?php echo site_url('welcome/stock_adjustment/') ?>">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <!-- newly added menus -->
                                    <li id="">
                                        <a class="submenu" href="<?= site_url('billers/table_list'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> List Tables</span>
                                        </a>
                                    </li>
                                    <li id="">
                                        <a class="submenu" href="<?= site_url('billers/create_table'); ?>">
                                            <i class="fa fa-user-plus"></i><span class="text"> Add Table</span>
                                        </a>
                                    </li>

                                    <li id="">
                                        <a class="submenu" href="<?= site_url('billers/waiter_list'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> List Salesman</span>
                                        </a>
                                    </li>
                                    <li id="">
                                        <a class="submenu" href="<?= site_url('billers/create_waiter'); ?>">
                                            <i class="fa fa-user-plus"></i><span class="text"> Add Salesman</span>
                                        </a>
                                    </li>
                                    <!-- end newly added menus -->
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_b_plus_report" style="cursor: pointer;">
                                        <a href="<?= site_url('reports/b_plus_report') ?>">
                                            <i class="fa fa-users"></i><span class="text"> B+ Last Month Report</span>
                                        </a>
                                    </li>
                                    <li id="report_b_plus_daily_report" style="cursor: pointer;">
                                        <a href="<?= site_url('reports/b_plus_daily_report') ?>">
                                            <i class="fa fa-users"></i><span class="text"> B+ Daily Report</span>
                                        </a>
                                    </li>
                                    <li id="report_b_plus_daily_report_custom" style="cursor: pointer;">
                                        <a href="<?= site_url('reports/b_plus_daily_report_custom') ?>">
                                            <i class="fa fa-users"></i><span class="text"> B+ Custom Report</span>
                                        </a>
                                    </li>
