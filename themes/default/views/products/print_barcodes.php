                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input name="add_code" type="checkbox" id="add_code" value="1" style="display:inline-block;" />
                            <label for="supplier_code" class="padding05"><?= lang('supplier_code'); ?></label> -->
                        </div>

                        <!--Two row added for supplier's code & memo number  -->
	                    <div class="form-group">
	                        <?= lang("add_code", "add_code"); ?>
	                        <?php echo form_input('add_code', '', 'class="form-control" id="add_code" name="add_code" placeholder="' . $this->lang->line("add_code_ex_S.CODE-_Memo_number") . '"'); ?>
	                    </div>

	                    <!--End of Two row added for supplier's code & memo number  -->	
                            ...
                            if (!empty($barcodes)) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        echo '<span class="barcode_image">'.$_POST["add_code"].'</span>';
                                        if ($style == 50) {
                                            echo '</div>';
                                        }
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('ifChecked', '#add_code', function(event) {
            localStorage.setItem('add_code', 1);
        });
