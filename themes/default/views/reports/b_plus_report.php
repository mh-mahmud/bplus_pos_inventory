...
<div class="row">
	<div class="col-md-12">
	    <h1 style="text-align: center;background-color: #fff;padding: 10px;margin-bottom: 30px">B+ ARA Center</h1>
		<h2 style="text-align: center;background-color: #fff;padding: 10px;margin-bottom: 30px">B+ Monthly Report (<?php echo $month; ?>)</h2>
	</div>
</div>
		...
		<table class="table table-striped table-bordered table-condensed table-hover dfTable reports-table">
			...
			<?php else: ?>
				<tr>
					...
					?>
					<!-- <td><?php //echo array_sum($all_stock_balance); ?></td> -->
					<!-- add open stock & receive for total -->
					<td><?php echo array_sum($os)+$receive_total; ?></td>
					<td>
						<?php
							$total_amount_data = $open_stock_val + $tot_rcv_val;
							echo $total_amount_data;
						?>
					</td>
				</tr>
			<?php endif; ?>
...
?>
				<tr>
					...
					<td>
						<?php
							$total_balance_stock = ($total_amount_data - array_sum($y));
