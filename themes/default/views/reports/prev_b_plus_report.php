<div class="row">
	<div class="col-md-12">
		<h2 style="text-align: center;background-color: #fff;padding: 10px;margin-bottom: 30px">B+ Monthly Report</h2>
	</div>
</div>
	...
	<div class="col-md-12">
		<table class="table table-striped table-bordered table-condensed table-hover dfTable reports-table">
			...
			<tr>
					...
					foreach($stock_report as $stock_val) {
						...
						foreach($cat_sale as $cat_val) {
							if($stock_val->code==$cat_val->code) {
								// echo number_format($cat_val->qty, 0);
								// continue;
								$stock_balance = $stock_val->QB - $cat_val->qty;
				...
				<td><?php echo ($stock_amount - array_sum($y)); ?></td>
			</tr>
		</table>
	</div>
</div>
