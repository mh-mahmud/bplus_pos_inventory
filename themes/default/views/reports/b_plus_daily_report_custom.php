...
?>
            ...
            <?php $attrib = array( 'role' => 'form'); echo form_open("reports/b_plus_daily_report_custom", $attrib); ?>
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<!-- <label for="podate" style="color:red;">Custom Date *</label> -->
							<input type="text" name="custom_date" class="form-control date" placeholder="Enter custom Date" required>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
...
<div class="row">
	<div class="col-md-12">
		<h2 style="text-align: center;background-color: #fff;padding: 10px;margin-bottom: 30px">B+ Custom Report (<?php echo date("Y-m-d", strtotime($start_date)); ?>)</h2>
	</div>
</div>
