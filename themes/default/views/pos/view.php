...
<div id="wrapper">
    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            <?php
            	echo "<p>". lang("Biller"). ": ". $biller->name.
            ...
            <?php }
                ...
                echo lang("Table Name"). ": " . $inv->table_name ."<br>" ;
				echo lang("Salesman Name"). ": " . $inv->waiter_name ."<br>" ;
        ...
        <div class="order_barcodes">
           <center><img src="../images/qr1.png" style="width:100px;height:100px;"/></center>         
           <center><b>Powered By: <a style="text-decoration:none;" href="https:\\m.me\foxweb.us">Fox Web LLC </a> </b></center>
            <!--<center><b>Cell: 01776457474, 01722432578</b></center> -->
             
             <!--<img src="../images/qr2.png" style="width:100px;height:100px;"/> -->
...
<div style="width: 50%;margin: 20px auto;font-size:12px">
