        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn bblack" style="cursor: default;"><span style="color:red;background-color:#fff;padding:12px"><b>Cash: <?php echo $running_cash; ?> /-</b></span></a>
                    </li>
                    <li class="dropdown">
                        <a class="btn bblack" style="cursor: default;"><span style="color:red;background-color:#fff;padding:12px"><b>VAT: <?php echo number_format($total_vat, 0); ?> /-</b></span></a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div id="leftdiv">
                        ...
                        <div id="left-top">
                            ...
                            <div class="no-print">
                                ...
                                ?>
                                <div class="form-group">
                                    <?php $tables = $this->db->query("SELECT * FROM sma_table")->result(); ?>
                                    <select id="table_select" name="table_name">
                                        <?php foreach($tables as $t_val) : ?>
                                            <option value="<?php echo $t_val->table_name ?>"><?php echo $t_val->table_name; ?></option>
                                        <?php endforeach; ?>
                                    </select>

                                    <?php $waiters = $this->db->query("SELECT * FROM sma_waiter")->result(); ?>
                                    <select id="waiter_select" name="waiter_name">
                                        <?php foreach($waiters as $w_val) : ?>
                                            <option value="<?php echo $w_val->waiter_name ?>"><?php echo $w_val->waiter_name; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
