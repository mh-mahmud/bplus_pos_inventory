...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>List Salesman</h2>
                ...
                <div class="table-responsive">
                    <table id="" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <?php foreach($get_record as $val) : ?>
                            <tr>
                                <td><?= $val->waiter_id ?></td>
                                <td><?= $val->waiter_name ?></td>
                                <td><?= $val->waiter_desc ?></td>
                                <td>
                                    <!-- <a class="btn btn-success btn-xs" href="<?php //echo base_url() ?>billers/table_list/edit/<?php echo $val->table_id; ?>">Edit</a> -->
                                    <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>billers/waiter_delete/<?php echo $val->waiter_id; ?>">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
